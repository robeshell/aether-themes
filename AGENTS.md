...
When asked to build a personal blog with this repository, read [`skills/aether-blog/SKILL.md`](./skills/aether-blog/SKILL.md) before making changes. Use [`THEME_CONTRACT.md`](./THEME_CONTRACT.md) for markup hooks and [`aether.config.example.mjs`](./aether.config.example.mjs) for theme selection.
